...
#        spec-reviewer, figma-builder, figma-token
# ============================================================
...
case "$COLOR_NAME" in
  ...
  warn)    COLOR=16776960 ;;
  info)    COLOR=3447003 ;;
  think)   COLOR=10181046 ;; # 보라색 (분석/사고 중)
  discuss) COLOR=15844367 ;; # 금색 (의견/토론)
  *)       COLOR=3447003 ;;
esac
...
case "$AGENT" in
  ...
  security-reviewer)
    ...
    AVATAR="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f6e1.png"  # 🛡️
    ;;
  ...
  figma-builder)
    ...
    AVATAR="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f3d7.png"  # 🏗️
    ;;
  figma-token)
  ...
  *)
    USERNAME="System"
    AVATAR="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/2699.png"   # ⚙️
    ;;
esac
