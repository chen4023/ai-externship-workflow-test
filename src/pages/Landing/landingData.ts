...
// Figma MCP에서 추출한 실제 이미지 에셋 (7일 유효)
export const LANDING_TABS: LandingTabData[] = [
  {
    ...
    images: {
      main: "/images/landing/quiz-main.png",
      overlay: "/images/landing/quiz-overlay.png",
      side: "/images/landing/quiz-side.png",
    },
  ...
  },
  {
    ...
    images: {
      main: "/images/landing/qna-main.png",
      overlay: "/images/landing/qna-overlay.png",
      side: "/images/landing/qna-side.png",
    },
    bannerTitle: "함께 묻고 답하며,\n현직자의 피드백으로 빠르게 성장할 수 있어요",
    chatBubbles: [
      { text: "JavaScript 질문있어요!", align: "right" },
  ...
  },
  {
    ...
    images: {
      main: "/images/landing/community-main.png",
      overlay: "/images/landing/community-overlay.png",
      side: "/images/landing/community-side.png",
    },
    bannerTitle: "함께 묻고 답하며,\n현직자의 피드백으로 빠르게 성장할 수 있어요",
    chatBubbles: [
      { text: "JavaScript 질문있어요!", align: "right" },
